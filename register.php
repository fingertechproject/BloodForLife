...
$sql="INSERT INTO `register` ( `fname`, `bgroup`, `age`, `mobile`, `state`, `district`, `city`, `email`, `password`,  `availbility`, `datetime`) VALUES ( '$name', '$bgroup', '$dage', '$phone', '$state', '$district', '$city', '$email',  '$password',  '$avail', current_timestamp());";
 ...
 if($run==true)
 {
  ...
  ?>
    <div class="shadow p-3 mb-5 bg-body rounded ">
    <div class="container mb-2 w-40 col-md-5 ">
    <form  action="register.php" method="post"class="mb-3 w-60 col-md-10 ">
